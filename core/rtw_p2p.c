...
u32 build_assoc_req_wfd_ie(struct wifidirect_info *pwdinfo, u8 *pbuf)
{
	...
	/* Only P2P GO or P2P GC need to include the WFD IE in the association request */
	if (!rtw_p2p_chk_role(pwdinfo, P2P_ROLE_GO) && !rtw_p2p_chk_role(pwdinfo, P2P_ROLE_CLIENT))
		goto exit;
